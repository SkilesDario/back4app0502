...
UUID=${UUID:-'9908bd8f-035b-4f6e-95bd-4c7bd7248ca5'}
VMESS_WSPATH=${VMESS_WSPATH:-'/9908bd8f-035b-4f6e-95bd-4c7bd7248ca5-vmess'}
VLESS_WSPATH=${VLESS_WSPATH:-'/9908bd8f-035b-4f6e-95bd-4c7bd7248ca5-vless'}
TROJAN_WSPATH=${TROJAN_WSPATH:-'/9908bd8f-035b-4f6e-95bd-4c7bd7248ca5-trojan'}
SS_WSPATH=${SS_WSPATH:-'/9908bd8f-035b-4f6e-95bd-4c7bd7248ca5-shadowsocks'}
